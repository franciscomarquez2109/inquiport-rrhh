...
?>
 ...
 <head>
  ...
  <script type="text/javascript" src="../assets/js/unlockUser.js"></script>
 ...
 <body>
    ...
    <div class="col-sm-12 col-md-offset-3 col-xs-offset-1 col-md-6 col-xs-12" style="margin-top: 20%;">
        <div class="panel panel-default">
            <div class="panel-heading text-center" style="color:#25373D; font-size: 20px;"><strong>Desbloquear Usuario</strong></div>
            <div class="panel-body">
              <div class="form-group">
                <strong id="info" class="text-center"></strong>
              </div>
              <form action="../control/unlockUser.php" method="POST" id="form-people">
                <div class="form-group">
                  <label for="r1">Pregunta 1:</label>
                  <div class="input-group">
                    <span class="input-group-addon"><strong><?php echo $_SESSION['pregunta1']; ?></strong></span>
                    <input type="password" id="r1" name="r1" class="form-control" placeholder="Respuesta 1" data-toggle="tooltip" data-placement="right" title="campo de respuesta">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" id="r2" name="r2" class="form-control" placeholder="Respuesta 2" data-toggle="tooltip" data-placement="right" title="campo de respuesta">
                  </div>
                </div>
                <div class="form-group">
                  <hr>
